            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div className="flex flex-col space-y-7">
                    ...
                    <select
                        ...
                        className="border rounded px-2 py-1 h-20 bg-orange-300  text-black text-xl"
                    >
                        <option disabled value="">Pick With Age</option>
                    ...
                    <select
                        ...
                        onChange={handleFilterChange}
                        className="border rounded px-2 py-1 h-20 bg-blue-gray-700 text-white text-xl"
                    >
                        <option disabled value="">Filter With division</option>
                    ...
                    <select
                        ...
                        onChange={handleFilterChange}
                        className="border rounded px-2 py-1 h-20 bg-blue-500 text-white text-xl"
                    >
                        <option disabled value="">Filter With Type</option>
